...
class HelpMenu:
    ...
    def __init__(self):
        ...
        parser.add_argument("(d)isplay [LEVEL] [# TO DISPLAY]", help="Displays list of problems. Optionally, can display by level [(e)asy, (m)edium, (h)ard]. Optionally, can also choose how many problems to display, default is {default1}. Ex: 'd' is to display next {default2} problems of all levels, 'd e 30' is to display the next 30 easy problems.".format(default1=QuestionList.DEFAULT_NUM_TO_DISPLAY,default2=QuestionList.DEFAULT_NUM_TO_DISPLAY))
